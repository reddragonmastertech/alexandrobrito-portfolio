          ...
          <div className="flex-1 min-w-[280px]">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href={profile.social.linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  {profile.social.linkedin.replace('https://www.', '').replace('https://', '')}
                </a>
              </div>
              <div className="flex items-center gap-3">
                <FaGithub className="text-primary" />
                <a href={profile.social.github} target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
