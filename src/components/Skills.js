              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4">
                ...
                >
                    <div className="relative">
                      ...
                      <div className="relative h-16 w-16 flex items-center justify-center rounded-xl bg-gradient-to-br from-card to-muted/50 border border-border/50 group-hover:border-primary/50 transition-all duration-300 group-hover:shadow-lg mx-auto">
                        <motion.img 
                          src={skill.icon} 
                          alt={skill.name} 
